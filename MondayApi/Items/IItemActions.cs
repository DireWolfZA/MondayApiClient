...
namespace MondayApi.Items {
    public interface IItemActions {
        ...
        /// </param>
        Task<Item> Create(string itemName, string boardID, string? groupID = null, IEnumerable<IColumnValue>? columnValues = null, bool? createLabelsIfMissing = null, string? relativeTo = null, PositionRelative? positionRelative = null);
        ...
        Task<IEnumerable<Item>> CreateMultiple(IEnumerable<Item> items, bool? createLabelsIfMissing = null);
        Task<Item> MoveToGroup(string itemID, string groupID);
        ...
        /// <see cref="Columns.IColumnActions.GetSubitemsBoardID"/> before calling this method.
        /// </param>
        Task<Item> MoveToBoard(string itemID, string boardID, string groupID, IEnumerable<ColumnMappingInput>? columnsMapping = null, IEnumerable<ColumnMappingInput>? subitemsColumnsMapping = null);
        Task<Item> Duplicate(string itemID, string boardID, bool? withUpdates = false);
        Task<Item> Delete(string id);
        Task<IEnumerable<Item>> DeleteMultiple(IEnumerable<string> ids);
    }
}
