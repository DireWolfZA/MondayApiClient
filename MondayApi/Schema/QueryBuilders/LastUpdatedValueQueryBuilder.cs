...
namespace MondayApi.Schema {
    public class LastUpdatedValueQueryBuilder : GraphQlQueryBuilder<LastUpdatedValueQueryBuilder> {
        ...
        public LastUpdatedValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public LastUpdatedValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public LastUpdatedValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
