...
namespace MondayApi.Schema {
    public class DropdownValueQueryBuilder : GraphQlQueryBuilder<DropdownValueQueryBuilder> {
        ...
        public DropdownValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public DropdownValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public DropdownValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
