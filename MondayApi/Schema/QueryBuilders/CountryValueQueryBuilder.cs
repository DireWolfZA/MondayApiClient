...
namespace MondayApi.Schema {
    public class CountryValueQueryBuilder : GraphQlQueryBuilder<CountryValueQueryBuilder> {
        ...
        public CountryValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public CountryValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public CountryValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
