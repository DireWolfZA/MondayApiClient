...
namespace MondayApi.Schema {
    public class UnsupportedValueQueryBuilder : GraphQlQueryBuilder<UnsupportedValueQueryBuilder> {
        ...
        public UnsupportedValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public UnsupportedValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public UnsupportedValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
