...
namespace MondayApi.Schema {
    public class ColumnValueQueryBuilder : GraphQlQueryBuilder<ColumnValueQueryBuilder> {
        ...
        public ColumnValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public ColumnValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public ColumnValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
