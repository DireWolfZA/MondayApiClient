...
namespace MondayApi.Schema {
    public class LongTextValueQueryBuilder : GraphQlQueryBuilder<LongTextValueQueryBuilder> {
        ...
        public LongTextValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public LongTextValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public LongTextValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
