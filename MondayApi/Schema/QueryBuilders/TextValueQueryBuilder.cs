...
namespace MondayApi.Schema {
    public class TextValueQueryBuilder : GraphQlQueryBuilder<TextValueQueryBuilder> {
        ...
        public TextValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public TextValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public TextValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
