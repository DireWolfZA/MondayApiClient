...
namespace MondayApi.Schema {
    public class ItemIDValueQueryBuilder : GraphQlQueryBuilder<ItemIDValueQueryBuilder> {
        ...
        public ItemIDValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public ItemIDValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public ItemIDValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
