...
namespace MondayApi.Schema {
    public class ColorPickerValueQueryBuilder : GraphQlQueryBuilder<ColorPickerValueQueryBuilder> {
        ...
        public ColorPickerValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public ColorPickerValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public ColorPickerValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
