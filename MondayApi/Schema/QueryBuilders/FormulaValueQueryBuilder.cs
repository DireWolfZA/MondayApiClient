...
namespace MondayApi.Schema {
    public class FormulaValueQueryBuilder : GraphQlQueryBuilder<FormulaValueQueryBuilder> {
        ...
        public FormulaValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public FormulaValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public FormulaValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
