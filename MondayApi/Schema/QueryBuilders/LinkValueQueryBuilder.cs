...
namespace MondayApi.Schema {
    public class LinkValueQueryBuilder : GraphQlQueryBuilder<LinkValueQueryBuilder> {
        ...
        public LinkValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public LinkValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public LinkValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
