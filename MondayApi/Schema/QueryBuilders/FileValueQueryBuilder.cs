...
namespace MondayApi.Schema {
    public class FileValueQueryBuilder : GraphQlQueryBuilder<FileValueQueryBuilder> {
        ...
        public FileValueQueryBuilder ExceptID() =>
            ExceptField("id");
        public FileValueQueryBuilder WithIsLeaf(string? alias = null, IncludeDirective? include = null, SkipDirective? skip = null) =>
            WithScalarField("is_leaf", alias, new GraphQlDirective?[] { include, skip });
        public FileValueQueryBuilder ExceptIsLeaf() =>
            ExceptField("is_leaf");
