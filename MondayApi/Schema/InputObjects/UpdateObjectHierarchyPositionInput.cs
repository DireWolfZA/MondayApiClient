...
namespace MondayApi.Schema {
    public class UpdateObjectHierarchyPositionInput : IGraphQlInputObject {
        private InputPropertyInfo _object;
        private InputPropertyInfo _newFolder;
        ...
        public QueryBuilderParameter<string?>? NewFolder {
            get => (QueryBuilderParameter<string?>?)_newFolder.Value;
            set => _newFolder = new InputPropertyInfo { Name = "newFolder", Value = value };
        }
        ...
        IEnumerable<InputPropertyInfo> IGraphQlInputObject.GetPropertyValues() {
            ...
            if (_newFolder.Name != null) yield return _newFolder;
